# Contributing to equeue

First and foremost, thank you! We appreciate that you want to contribute to equeue, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for equeue**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for equeue:

- star the [project](https://github.com/axetroy/equeue)
- tweet your support for equeue
...
- **version**: please note the version of equeue are you using
...
[so]: http://stackoverflow.com/questions/tagged/equeue